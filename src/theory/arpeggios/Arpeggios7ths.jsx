...
export default function Arpeggios7ths() {
    return (
      <div className="arpeggios">
        ...
        <section className="arpeggio-section">
          <h2>Arpeggios</h2>
          <div className="arpeggio-grid arpeggio-grid--arpeggios">
            <div className="arpeggio-card">
        ...
        <section className="arpeggio-section">
          <h2>7th Chords</h2>
          <div className="arpeggio-grid arpeggio-grid--sevenths">
            <div className="arpeggio-card">
              <h3>Dominant 7th</h3>
              <Dom7th />
